...
local action_to_user_command = {
	...
	execute_current_statement = "ExecuteCurrentStatement",
	execute_virtual_text = "ExecuteVirtualText",
	execute_rerun_last = "ExecuteRerunLast",
...
return {
	...
	set_keymaps = function(prefix, M)
		...
		local keymaps = {
			...
			execute_current_statement = {
				"xs",
				function() M.execute_current_statement() end,
				desc = "Execute Current Statement",
				icon = { icon = "", color = "green" },
			},
			execute_virtual_text = {
				"xv",
				M.execute_virtual_text,
				desc = "Execute Current Statement",
				icon = { icon = "", color = "green" },
			},
			execute_rerun_last = {
	...
	set_user_commands = function(M)
		local commands = {
			...
			ExecuteVirtualText = M.execute_virtual_text,
