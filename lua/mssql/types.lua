...
---@field display_scalar_as_virtual_text? boolean Allow automatic virtual text for single scalar values (default false).
...
---@field deny string[]? List of patterns to deny. Deny takes precedence.
...
---@class MssqlStatementSelection
---@field startLine integer 0-indexed start line of the statement
---@field endLine integer 0-indexed end line of the statement
---@field startColumn integer 0-indexed start column of the statement
---@field endColumn integer 0-indexed end column of the statement
...
---@field selection? MssqlStatementSelection Parsed statement selection range
...
---@field execute_virtual_text fun(opts?: MssqlExecutionOptions): MssqlQueryExecuteSubsetResult?, string?
---@field clear_virtual_text fun(bufnr?: integer)
...
---@field bufnr? integer
---@field virtual_text? boolean If true, display scalar results as inline virtual text.
---@field line? integer 0-indexed line number of executed statement.
---@field column? integer 0-indexed column number of executed statement.

---@class GetResultsBufferOpts
---@field all? boolean Return all matching buffers if true.

---@class ShowResultSetContext
---@field result_set_summary MssqlResultSetSummary
---@field batch_summary? MssqlBatchSummary
---@field subset_params SubsetParams
---@field config MssqlConfig
---@field exec_opts? MssqlExecutionOptions
